...
public class FoodTypeRepositoryImpl implements FoodTypeRepository {
  ...
  public void save(FoodType foodType) {
    String sql = "INSERT INTO food_type (name, unit, calories_per_unit, picture) VALUES (?, ?, ?, ?)";
  ...
  public void update(FoodType foodType) {
    String sql = "UPDATE food_type SET name = ?, unit = ?, calories_per_unit = ?, picture = ? WHERE id = ?";
